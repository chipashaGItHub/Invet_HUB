...
#      timestamps(type: :utc_datetime)
  ...
  def create do
    execute("INSERT INTO tbl_users (last_name,first_name,profile,auto_password, username, password, status, email, inserted_at, updated_at) VALUES ('Mumbi','Victor','Mwendal Investment','Y','admin',UPPER(SHA2('Brokenv1c', 512)),true,'victormumbi0@gmail.com',current_date,current_date)")
    end
