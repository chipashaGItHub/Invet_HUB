...
$(document).ready(function() {
    ...
    // variation delete table
    $('#dt-basic-example tbody').on( 'click', '.js-variation-delete', function () {
        var button = $(this);
        Swal.fire({
            title: 'Are you sure?',
            text: "You won't be able to revert this!",
            ...
            spinner.show();
            $.ajax({
                url: '/InvetHub/catalog/variation/delete',
                type: 'POST',
                data: {id: button.attr("data-variation-id"), _csrf_token: $("#csrf").val()},
                success: function(result) {
                    spinner.hide();
                    if (result.info){
                        Swal.fire(
                            'Success',
                            'variation deleted successfuly!',
                            'success'
                        )
    ...
    $('#dt-users tbody').on( 'click', '.js-branch-delete', function () {
        ...
        Swal.fire({
            ...
            spinner.show();
            $.ajax({
                url: '/InvetHub/catalog/delete_branch',
                type: 'POST',
...
//System activate user
    ...
    // $('#dt-invet-table').DataTable({"responsive": true});
    $('#dt-invet-table tbody').on( 'click', '.js-delete-inventory', function () {
        var button = $(this);
        Swal.fire({
            title: 'Are you sure?',
            text: "You won't be able to revert this!",
            ...
            spinner.show();
            $.ajax({
                url: '/invetHub/Inventory/inventory/delete',
                type: 'POST',
                data: {id: button.attr("data-id"), _csrf_token: $("#csrf").val()},
                success: function(result) {
                    spinner.hide();
    ...
    $('#dt-invet-table tbody').on( 'click', '.js-activate-stock', function () {
        var button = $(this);
        Swal.fire({
            title: 'Are you sure?',
            text: "You won't be able to revert this!",
            ...
            if (result.value) {
                spinner.show();
                $.ajax({
                    url: '/invetHub/Inventory/inventory/clear_stock',
                    type: 'POST',
                    data: {id: button.attr("data-id"), _csrf_token: $("#csrf").val()},
                    success: function(result) {
                        spinner.hide();
    ...
    //Dt Third Party Accounts Delete functionality
    $('#dt-banks').DataTable({
        "sScrollX": "100%",
        "sScrollXInner": "110%",
    ...
    $('#dt-banks tbody').on( 'click', '.js-delete-bank', function () {
        ...
        Swal.fire({
            ...
            spinner.show();
            $.ajax({
                url: '/ZicbProxy/user_management/third_party_accounts/delete',
                type: 'POST',
                ...
                success: function(result) {
                    ...
                    if (result.data){
                        Swal.fire(
                            'Success',
                            'Third party account has been deleted successfuly!',
                            'success'
                        )
                        location.reload(true);
                    } else {
 ...
 // perform calclations on the inventory passed
function calc() {
    var id = document.getElementById('id')
    var quantity = document.getElementById('quantity').value;
    var price = document.getElementById('price').value;
    var prodVal = document.getElementById('product');
    ...
    prodVal.value = product;

    var result = prodVal.value;
